...
enum ACTIVATE_STATES {
	...
	ACTIVATE_STATE_SCAN_MATRIX1,
	ACTIVATE_STATE_SCAN_MATRIX2,
...
enum TLS_HANDSHAKE_STATES {
	TLS_HANDSHAKE_STATE_CLIENT_HELLO_SND,
	TLS_HANDSHAKE_STATE_CLIENT_HELLO_RCV,
	TLS_HANDSHAKE_STATE_SERVER_HELLO_SND,
...
static const struct data_exchange_t ACTIVATE_SEQUENCES[] = {
	...
	{
		.msg = SCAN_MATRIX1,
		.msg_length = G_N_ELEMENTS(SCAN_MATRIX1),
		.rsp = (unsigned char []) { 0x06, 0x04 },
		.rsp_length = 2,
	},
	{
		.msg = SCAN_MATRIX2,
		.msg_length = G_N_ELEMENTS(SCAN_MATRIX2),
		.rsp = NULL,
		.rsp_length = 2366,
	},
};
